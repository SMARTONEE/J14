...
# directory = []
# directory << Hash[get_symbols.zip(get_prices)]
# # directory << { get_symbols => get_prices }
...
def get_hash_crypto
    ...
    get_symbols.each_with_index {|k, i| hash_crypto << {k => all_prices[i]}}
    hash_crypto
end

puts get_hash_crypto